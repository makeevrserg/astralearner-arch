...
object AstraApk {
    ...
    val Project.KEY_ALIAS: String
        get() = AstraApk.getCredential(this, "KEY_ALIAS")
    val Project.KEY_PASSWORD: String
        get() = AstraApk.getCredential(this, "KEY_PASSWORD")
    val Project.STORE_PASSWORD: String
        get() = AstraApk.getCredential(this, "STORE_PASSWORD")

    val Project.WEB_CLIENT_ID: String
        get() = AstraApk.getCredential(this, "WEB_CLIENT_ID")
    val Project.BANNER_AD_UNIT_ID: String
        get() = AstraApk.getCredential(this, "BANNER_AD_UNIT_ID")
    val Project.ACTIVITY_AD_UNIT_ID: String
        get() = AstraApk.getCredential(this, "ACTIVITY_AD_UNIT_ID")
    val Project.INTERSITIAL_AD_UNIT_ID: String
        get() = AstraApk.getCredential(this, "INTERSITIAL_AD_UNIT_ID")
